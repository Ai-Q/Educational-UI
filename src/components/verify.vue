      ...
      <div :style="'position:relative;overflow:hidden;width:'+ dataWidth +'px;'">
        ...
        <p class="ver-tips" ref="verTips" :style="'height: '+22*scale+'px;line-height:'+22*scale+'px;bottom: ' + (displayTips ? 0 : -22*scale ) +'px;font-size: '+12*scale+'px;'">
          <template v-if="verification">
            <span :style="'color:#42ca6b;line-height:'+ 22*scale+'px;'">��֤ͨ��</span><span></span>
          </template>
          <template v-if="!verification">
            <span :style="'color:red;line-height:'+22*scale+'px;'">��֤ʧ��:</span>
            <span :style="'margin-left:'+4*scale+'px;line-height:'+ 22*scale+'px;'">�϶����齫����ͼ����ȷƴ��</span>
          </template>
        </p>
      </div>
      <div class="re-btn" @click="refreshImg" :style="'height: '+28*scale+'px;padding: '+1*scale+'px '+16*scale+'px;font-size: '+18*scale+'px;'"><a-icon type="redo"/></div>
    </div><br>
    <div class="slider-container" :style="'width:' + dataWidth + 'px;'">
      <div class="slider-bar" :style="'border-radius:'+ 24*scale+'px;'">
        <p class="slider-bar-text select-none" onselectstart="return false" :style="'line-height:' + 28*scale + 'px;font-size:'+12*scale+'px;'">��ס���飬 �϶�����Ϸ�ƴͼ</p>
      </div>
